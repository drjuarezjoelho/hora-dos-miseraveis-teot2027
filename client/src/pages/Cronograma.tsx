...
const cycles = [
  ...
  },
  {
    ...
    link: "/ciclo5",
    weeks: [
      { w: "51-52", topic: "Diagnóstico final de lacunas + revisão trauma de alto impacto" },
      { w: "53-55", topic: "Ortopedia clínica + especialidades + classificações críticas" },
      { w: "56-58", topic: "Simulados progressivos e correção orientada por erro" },
      { w: "59-60", topic: "Revisão personalizada e simulado pré-prova" },
      { w: "61-62", topic: "Reta final (drill 7 dias) + estratégia dia TEOT" },
    ],
  },
];
