...
const allModules = [
  {
    ...
    items: [
      "Anatomia aplicada e biomecânica",
      "Fisiopatologia óssea e articular",
      "Exame físico e semiologia ortopédica",
      "Princípios de imagem e classificações",
    ],
  },
  {
    cycle: 2,
